...
void P_Road_Lookup_Table::initialize()
{
    ...
    for (int try_num = 1; try_num <= MAX_TRY_NUM; try_num++)
    {
        for (int r_int = 0; r_int <= MAX_R; r_int++)
        {
            ...
            {
            case 2:
                prob = ((2.0 - R) > 0 ? 2.0 : ((2.0 - R) < 0 ? 0.0 : 1.0)) / (16.0 * M_PI * R);
                break;
            case 3:
            ...
            case 7:
                ...
                break;
            case 8:
                prob = -(1.0 / (737280 * M_PI * R)) * (70 * pow(R, 6) - 56 * pow(2 + R, 6) + 28 * pow(4 + R, 6) - 8 * pow(6 + R, 6) + pow(8 + R, 6) +
                                                       56 * pow(-2 + R, 6) * sign_func(2 - R) - // 修正：使用sign_func
                                                       28 * pow(-4 + R, 6) * sign_func(4 - R) +
                                                       8 * pow(-6 + R, 6) * sign_func(6 - R) -
                                                       pow(-8 + R, 6) * sign_func(8 - R));
                break;
            case 9:
                prob = 1.0 / (10321920 * M_PI * R) * (pow(fabs(-9 + R), 7) - 9 * pow(fabs(-7 + R), 7) + 2.0 * (91035 * R - 13545 * pow(R, 3) + 945 * pow(R, 5) - 35 * pow(R, 7) + 18 * pow(fabs(R - 5), 7) - 42 * pow(fabs(R - 3), 7) + 63 * pow(fabs(R - 1), 7))); // 修正：63而不是10
                break;
            case 10:
                prob = 1.0 / (165150720 * M_PI * R) * (252 * pow(R, 8) - 210 * pow(2 + R, 8) + 120 * pow(4 + R, 8) - 45 * pow(6 + R, 8) + 10 * pow(8 + R, 8) - pow(10 + R, 8) + 210 * pow(-2 + R, 8) * sign_func(2 - R) - // 修正：使用sign_func
                                                       120 * pow(-4 + R, 8) * sign_func(4 - R) + 45 * pow(-6 + R, 8) * sign_func(6 - R) - 10 * pow(-8 + R, 8) * sign_func(8 - R) + pow(-10 + R, 8) * sign_func(10 - R));
                break;
            case 11:
                ...
                break;
            case 12:
                prob = -1.0 / (59454259200 * M_PI * R) * (924 * pow(R, 10) - 792 * pow(2 + R, 10) + 495 * pow(4 + R, 10) - 220 * pow(6 + R, 10) + 66 * pow(8 + R, 10) - 12 * pow(10 + R, 10) + pow(12 + R, 10) + 792 * pow(-2 + R, 10) * sign_func(2 - R) - // 修正：使用sign_func
                                                          495 * pow(-4 + R, 10) * sign_func(4 - R) + 220 * pow(-6 + R, 10) * sign_func(6 - R) - 66 * pow(-8 + R, 10) * sign_func(8 - R) + 12 * pow(-10 + R, 10) * sign_func(10 - R) - pow(-12 + R, 10) * sign_func(12 - R));
                break;
            default:
                prob = 1.0 / (4 * M_PI * R);
                break;
